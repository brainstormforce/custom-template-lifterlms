...
Custom Template for LifterLMS is a WordPress plugin by Brainstorm Force. Replace default LifterLMS course template for non-enrolled students with a custom page-builder template.

- **Version:** 1.0.6
- **Text Domain:** custom-template-lifterlms
- **Main File:** custom-template-lifterlms.php
...
- Entry point: `custom-template-lifterlms.php`
...
- Use `custom-template-lifterlms` text domain for all translatable strings
