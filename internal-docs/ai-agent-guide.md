# AI Agent Guide — Custom Template for LifterLMS

## Quick Start for AI Agents

1. **Entry point:** Start at `custom-template-lifterlms.php` to understand plugin initialization
...
4. **Text domain:** Use `custom-template-lifterlms` for all translatable strings
...
1. Wrap strings in `__( 'text', 'custom-template-lifterlms' )` or `esc_html__( 'text', 'custom-template-lifterlms' )`
...
- [ ] Text domain `custom-template-lifterlms` used for all user-facing strings
