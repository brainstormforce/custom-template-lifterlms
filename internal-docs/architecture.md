# Architecture — Custom Template for LifterLMS

## Overview

Custom Template for LifterLMS is a WordPress plugin that follows standard WordPress plugin architecture patterns.

## Entry Point

The plugin entry point is `custom-template-lifterlms.php`, which:
...
1. WordPress loads the plugin via `custom-template-lifterlms.php`
